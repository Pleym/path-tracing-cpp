...
; %bb.0:
	...
	str	x8, [sp]                        ; 8-byte Folded Spill
	mov	x9, #35898                      ; =0x8c3a
	movk	x9, #57904, lsl #16
	movk	x9, #31118, lsl #32
	movk	x9, #15941, lsl #48
	fmov	d1, x9
	str	d1, [sp, #16]
	ldr	d0, [x8]
	fabs	d0, d0
...
Lcst_begin0:
	.uleb128 Ltmp7-Lfunc_begin0             ; >> Call Site 1 <<
...
Lcst_begin3:
	...
	.uleb128 Ltmp44-Lfunc_begin3            ;   Call between Lfunc_begin3 and Ltmp44
	.byte	0                               ;     has no landing pad
	.byte	0                               ;   On action: cleanup
